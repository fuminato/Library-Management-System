        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="text-gray-600 hover:text-black">
              <svg width="32" height="32" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/><path d="M12 8v4l2 2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </button>
          </div>
        </div>
                ...
                ? filteredBorrowed.map((b) => (
                    <tr key={b.id} className="border-b">
                      ...
                      <td className="px-4 py-2">
                        {b.state === "returned" ? (
                          <span className="bg-green-100 text-green-700 px-3 py-1 rounded font-semibold">Returned</span>
                        ) : (
                          <span className="bg-red-100 text-red-700 px-3 py-1 rounded font-semibold">Borrowing</span>
                        )}
                      </td>
                    </tr>
                  ))
